...
<head>
	...
	<link rel="icon" href="<?= url('/assets/img/logo-lanis.png') ?>" type="image/x-icon"/>
	...
	<style>
		...
		.alert {
			box-shadow: 1px 1px 5px 0px rgba(18, 38, 70, 0.12);
		}
		...
		.label-success {
			background-color: rgb(143, 222, 119)
		}
		.label-danger {
			background-color: rgb(225, 151, 120)
		}
		.card {
...
<body>
	<div class="wrapper fullheight-side">
		<div class="logo-header position-fixed" data-background-color="blue">
			...
			<a href="#" class="logo">
				<img src="<?= url('/assets/img/logo-db.svg') ?>" alt="navbar brand" class="navbar-brand">
			</a>
		...
		<div class="main-panel full-height" style="background-image: url('{{ url('assets/bg-blur.png') }}'); background-size: 100% 100%;">
			...
			<footer class="footer">
				<div class="container-fluid">
					<div class="copyright ml-auto">
						<?= date('Y') ?> <i class="fa fa-heart heart text-danger"></i> {{ config('app.name') }} Maintenance.
					</div>				
				</div>
			</footer>
		</div>
